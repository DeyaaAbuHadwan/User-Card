class elements {// class have name and cards div
...
arr = { //initial array 2 d to save data from api 
    "name": [],
    "email": [],
    "gender": [],
    "phone": [],
        ...
        success: function (data) {
            ...
            $.each(data.results, function (key, value) {
                ...
                if (j != 0) {
                    ...
                    el.card = $clone;
                    $clone.appendTo($(".row"));
                    $clone.find('[id]').each(function () { this.id = (this.id).substring(0, getID(this.id)) + j });
                    addCard(j);
                    arrCards.push(el);
                    j++;
                } else {
